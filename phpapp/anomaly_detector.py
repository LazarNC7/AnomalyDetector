...
Suporta 4 combinatii train/test:
  ...
  2. Antreneaza pe CSV, testeaza pe LOG
     python anomaly_detector.py --train-csv payload_train.csv --test-log dataset_.log

  3. Antreneaza pe LOG, testeaza pe LOG (split intern)
     python anomaly_detector.py --train-log dataset_train_v2.log --test-log dataset_test_v2.log

  4. Antreneaza pe LOG, testeaza pe CSV
     python anomaly_detector.py --train-log dataset_train_v2.log --test-csv payload_test.csv
